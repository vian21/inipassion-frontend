          ...
          <div className="flex flex-col gap-y-8 text-small-regular">
            {!customer ? (
              <div className="flex flex-col gap-y-4 ">
                <span className="text-gray-700 uppercase">Compte</span>
                <Link href={`/account/login`} passHref>
                  ...
                  >
                    ...
                    <span className="normal-case">Connexion</span>
                    <ChevronDown className="-rotate-90" />
                  </button>
                </Link>
              </div>
              ...
              <div className="flex flex-col gap-y-4">
                ...
                <Link href={`/account`} passHref>
                  <button
                    ...
                    onClick={close}
                  >
                    <span className="sr-only">Aller à la page du compte</span>
            ...
            <div className="flex flex-col gap-y-4">
              ...
              >
                <span className="sr-only">
                  Cliquez pour sélectionner le pays d'expédition
                </span>
